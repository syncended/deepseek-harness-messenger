window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const STYLE_CSS = [
      ...
      ".dsh-msg-textarea{min-height:92px;resize:vertical;font-family:var(--dsw-font-mono);}",
      ...
      ".dsh-msg-toggle-track{position:relative;width:34px;height:19px;border-radius:10px;background:var(--dsw-alias-fill-l2);flex:none;transition:background .15s;}",
      ...
      ".dsh-msg-help code{font-family:var(--dsw-font-mono);background:var(--dsw-alias-interactive-bg-hover);border-radius:5px;padding:1px 5px;}",
