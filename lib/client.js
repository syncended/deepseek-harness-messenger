window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function MessengerSettings({ scope, settingsDescribe, api, credentialSignals }) {
      ...
      }, [api, settingsDescribe, settingsRetry, snapshot.status]);
    ...
    const STYLE_CSS = [
      ...
      ".dsh-msg-empty{padding:28px;border:1px dashed var(--dsw-alias-border-default,#d6dbe4);border-radius:12px;text-align:center;color:var(--dsw-alias-text-secondary,#687386);display:flex;flex-direction:column;align-items:center;gap:12px;}",
    ...
    exports.__testing = Object.freeze({ splitIds, telegramValue, sameTelegram, validateForm, messengerNamespace });
